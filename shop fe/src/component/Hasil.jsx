...
import { Badge, Button, Card, Col, ListGroup, ListGroupItem, Modal, Row } from "react-bootstrap";
        ...
        return (
            <Col md={3} className="mt-3">
                ...
                <ListGroup variant="flush">
                    ...
                    <ListGroup.Item style={{cursor:"pointer"}} key={menuKeranjang.id} onClick={() => this.handleShow(menuKeranjang)}>
                        <Row>
                            <Col xs={2}>
                                <h4>
